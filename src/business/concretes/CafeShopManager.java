...
public abstract class CafeShopManager implements CafeShopService {
    ...
    @Override
    public  abstract void register(CafeShop cafeShop) ;//Burada registeri subclasslar icerisinde override etmek ucun abstract class seklinde gotururuk
    //Bu da abstractiondir.
